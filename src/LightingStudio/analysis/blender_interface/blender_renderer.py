...
RENDER_ASSETS_SOURCE = Path(r"C:\Users\AviGoyal\Documents\LightingStudio\tmp\source\render_assets")
...
def render_blend_file(output_dir: Path) -> bool:
    ...
    blend_file = output_dir / "render_assets" / "prepared_blend_file_010.blend"
